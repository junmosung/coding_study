...
Kotlin을 주 언어로 익숙하게 사용하기 위한 학습 자료입니다.

## 학습 트랙

| 경로 | 내용 |
|---|---|
| [practice_by_claude](./practice_by_claude) | Kotlin 입문 문법 연습 |
...
- AI별 문제는 `practice_by_<name>` 형식으로 구분합니다.
- 패키지 이름은 해당 디렉터리 이름과 동일하게 유지합니다.
- 난이도 폴더는 `A_기본`, `B_중급`, `C_고급`, `D_최고급` 순서로 구성합니다.
- 빌드 결과와 IDE·AI 도구의 로컬 설정은 저장소에 포함하지 않습니다.
